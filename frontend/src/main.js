...
pluralCaseList.push( {plural: "orderManagements/orders", pascal: "OrderManagementOrder"} )

pluralCaseList.push( {plural: "foodPreparations/restaurants", pascal: "FoodPreparationRestaurant"} )

pluralCaseList.push( {plural: "deliveryManagements/deliveries", pascal: "DeliveryManagementDelivery"} )

pluralCaseList.push( {plural: "ratingManagements/ratings", pascal: "RatingManagementRating"} )

pluralCaseList.push( {plural: "appManagements/apps", pascal: "AppManagementApp"} )
