            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    ...
                    <v-list-item
                        class="px-2"
                        key="restaurants"
                        to="/foodPreparations/restaurants"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
...
export default {
    ...
    data: () => ({
        ...
        aggregate: [
            ...
            { 
                title: 'Restaurant', 
                description: 'Represents a restaurant that receives and prepares orders', 
                key: 'restaurants', 
                route: '/foodPreparations/restaurants',
                ImageUrl: '',
            },
            { 
                title: 'Delivery', 
                description: 'Represents a delivery made by a delivery driver', 
                key: 'deliveries', 
            ...
            { 
                title: 'Rating', 
                description: 'Represents a rating submitted by a user for a completed order', 
                key: 'ratings', 
                route: '/ratingManagements/ratings',
                ImageUrl: '',
            },
            { 
                title: 'App', 
                description: 'Represents the food delivery app', 
                key: 'apps', 
                route: '/appManagements/apps',
                ImageUrl: '',
            },
